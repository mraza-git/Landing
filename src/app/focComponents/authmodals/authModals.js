...
(function(){
  ...
  vm.openLoginModal = function (event) {
    ...
    vm.$mdDialog.show({
      ...
      templateUrl: 'app/focComponents/authmodals/login.web.html',
      targetEvent: event,
  ...
  vm.openRegisterModal = function (event) {
    vm.$mdDialog.show({
      ...
      templateUrl: "app/focComponents/authmodals/register.web.html",
      targetEvent: event,
      parent: angular.element(document.body),
      clickOutsideToClose: true,
      fullscreen: vm.$mdMedia('sm') || vm.$mdMedia('xs')
  ...
  vm.openForgotModal = function (event) {
    ...
    vm.$mdDialog.show({
      ...
      templateUrl: "app/focComponents/authmodals/forgot.web.html",
      targetEvent: event,
      parent: angular.element(document.body),
      clickOutsideToClose: true,
      fullscreen: vm.$mdMedia('sm') || vm.$mdMedia('xs')
  ...
  vm.openChangeModal = function (event) {
    vm.$mdDialog.show({
      ...
      templateUrl: "app/focComponents/authmodals/change.web.html",
      targetEvent: event,
      parent: angular.element(document.body),
      clickOutsideToClose: true,
      fullscreen: vm.$mdMedia('sm') || vm.$mdMedia('xs')
